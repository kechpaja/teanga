...
public class ParserTests extends TestCase {
	...
	public void testTokenizer() {
		...
		Tokenizer tkn4 = new Tokenizer("la bela kato manĝas la muson");
		Tokenizer tkn5 = new Tokenizer("La musoj manĝis rapide");
		Tokenizer tkn6 = new Tokenizer("LA KATOJ MANĜOS LA BELAJN MUSOJN");
		Tokenizer tkn7 = new Tokenizer("Mia domo estus en la ĝardeno");
	...
	public void testParseTokenStream() {
		...
		p.parse("la bela kato manĝas la muson");
		p.parse("belaj musoj manĝas la katojn");
