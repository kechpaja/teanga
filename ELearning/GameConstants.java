...
public final class GameConstants {
	...
	public static final int V_NUM_LEVEL_ONE = 2;
	public static final int G_NUM_LEVEL_ONE = 5;
	
	public static final int V_NUM_LEVEL_TWO = 5;
	public static final int G_NUM_LEVEL_TWO = 5;
	
	public static final int V_NUM_LEVEL_THREE = 5;
	public static final int G_NUM_LEVEL_THREE = 5;
	
	public static final int V_NUM_LEVEL_FOUR = 5;
	public static final int G_NUM_LEVEL_FOUR = 5;
	
	public static int getVNum(int level){
		switch (level){
		case 0: return V_NUM_LEVEL_ONE;
		case 1: return V_NUM_LEVEL_TWO;
		case 2: return V_NUM_LEVEL_THREE;
		case 3: return V_NUM_LEVEL_FOUR;
